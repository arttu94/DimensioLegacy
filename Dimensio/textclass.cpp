	...
	XMMATRIX baseViewMatrix)
{
	...
	result = m_Font->Initialize(device, deviceContext, "../Dimensio/data/fontdata.txt", "../Dimensio/data/font.tga");
	if (!result)
	{
...
bool TextClass::Render(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX orthoMatrix, XMMATRIX viewMatrix)
{
	bool result;
